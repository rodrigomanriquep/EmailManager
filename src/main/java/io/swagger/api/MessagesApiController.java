...
public class MessagesApiController implements MessagesApi {
    ...
    public ResponseEntity<Message> createMessage(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody MessageInput body) {
    ...
    public ResponseEntity<Void> deleteMessage(@Parameter(in = ParameterIn.PATH, description = "ID of the message to delete", required=true, schema=@Schema()) @PathVariable("messageId") Long messageId) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<Message> getMessageById(@Parameter(in = ParameterIn.PATH, description = "ID of the message to retrieve", required=true, schema=@Schema()) @PathVariable("messageId") Long messageId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Message>(objectMapper.readValue("{\n  \"userSender\" : {\n    \"name\" : \"Rodrigo Manrique da Penha\",\n    \"id\" : 1,\n    \"birthDate\" : \"2000-07-04T00:00:00.000+00:00\",\n    \"email\" : \"rodrigomanriquep@gmail.com\",\n    \"status\" : \"ACTIVE\"\n  },\n  \"date\" : \"2023-08-18T00:00:00.000+00:00\",\n  \"subject\" : \"Important Announcement\",\n  \"id\" : 1,\n  \"body\" : \"This is an important message.\"\n}", Message.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<Message> updateMessage(@Parameter(in = ParameterIn.PATH, description = "ID of the message to update", required=true, schema=@Schema()) @PathVariable("messageId") Long messageId,@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody MessageInput body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Message>(objectMapper.readValue("{\n  \"userSender\" : {\n    \"name\" : \"Rodrigo Manrique da Penha\",\n    \"id\" : 1,\n    \"birthDate\" : \"2000-07-04T00:00:00.000+00:00\",\n    \"email\" : \"rodrigomanriquep@gmail.com\",\n    \"status\" : \"ACTIVE\"\n  },\n  \"date\" : \"2023-08-18T00:00:00.000+00:00\",\n  \"subject\" : \"Important Announcement\",\n  \"id\" : 1,\n  \"body\" : \"This is an important message.\"\n}", Message.class), HttpStatus.NOT_IMPLEMENTED);

...
public class Scheduler   {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, scheduler.id) &&
        Objects.equals(this.user, scheduler.user) &&
        Objects.equals(this.message, scheduler.message) &&
        Objects.equals(this.status, scheduler.status) &&
